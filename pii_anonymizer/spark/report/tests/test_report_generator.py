...
class TestReportGenerator(TestCase):
    @patch(
        "pii_anonymizer.spark.report.report_generator.ReportGenerator.setup_logging_config"
    )
    ...
    @patch("logging.info")
    @patch(
        "pii_anonymizer.spark.report.report_generator.ReportGenerator.generate_report_content"
    )
