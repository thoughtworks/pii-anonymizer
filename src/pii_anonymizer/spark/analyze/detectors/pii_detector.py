...
from src.pii_anonymizer.spark.analyze.detectors.base_detector import BaseDetector
import src.pii_anonymizer.spark.analyze.detectors
    ...
    def __get_detector_modules(self):
        modules = [
            ...
            for importer, modname, ispkg in pkgutil.walk_packages(
                path=src.pii_anonymizer.spark.analyze.detectors.__path__,
                prefix=src.pii_anonymizer.spark.analyze.detectors.__name__ + ".",
            )
