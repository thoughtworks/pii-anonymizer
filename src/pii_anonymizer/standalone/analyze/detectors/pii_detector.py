...
import src.pii_anonymizer.standalone.analyze.detectors
from src.pii_anonymizer.standalone.analyze.detectors.base_detector import BaseDetector
from src.pii_anonymizer.standalone.anonymize.drop_anonymizer import DropAnonymizer
from src.pii_anonymizer.standalone.anonymize.anonymizer_result import AnonymizerResult
    ...
    def __get_detector_modules(self):
        modules = [
            ...
            for importer, modname, ispkg in pkgutil.walk_packages(
                path=src.pii_anonymizer.standalone.analyze.detectors.__path__,
                prefix=src.pii_anonymizer.standalone.analyze.detectors.__name__ + ".",
            )
